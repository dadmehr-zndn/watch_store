class AppStrings {
  ...
  static const String enterActivationCodeHint = '- - - - - -';
  static const String continueButton = 'ادامه';

  static const String register = 'ثبت‌نام';
  static const String chooseProfile = 'انتخاب تصویر پروفایل';
  ...
  static const String landlinePhone = 'تلفن ثابت';
  static const String landlinePhoneHint =
      'شماره تلفن ثابت را با پیش شماره وارد بفرمایید';
  static const String address = 'آدرس';
  static const String activeAddress = 'فعال آدرس';
  ...
  static const String bestSellings = 'پرفروش‌ها';
  static const String mostSellings = 'پرفروش‌‌ترین ها';
  ...
  static const String discount = 'با تخفیف';
  static const String count = 'عدد';
  static const String continueBuying = 'ادامه فرآیند خرید';
  static const String totalPrice = 'مجموع';

  static const String profleAppBar = 'پروفایل کاربر';
  static const String username = 'دادمهر زندیان';
  static const String termAndConditions = 'قوانین و مقررات';
  ...
  static const String fakeBrandCasio = 'کاسیو';
  static const String fakeCartCountItem = '2';
  static const String fakeSingleProductFullName = 'ساعت شیائومی mi Watch lite';
  static const String fakeProductCardTitle = 'بنسر';
  static const String fakeProductCardDetail =
      'مسواک بنسر مدل اکسترا با برس متوسط 3 عددی';
  static const String fakeProductFeatures = 'خصوصیات';
  static const String fakeProductReview = 'نقد و بررسی';
  static const String fakeProductComments = 'نظرات';
  static const String fakeLoremSendToAddress =
      'لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ ';
  static const String fakeProductLorem =
...
''';
  ...
  static const List<String> fakeTabViewItems = [
    fakeProductFeatures,
    fakeProductReview,
    fakeProductComments,
  ];
